...
".venv\Scripts\pyinstaller.exe" src\desktop.py --name SlopeAnalysis --windowed --onedir --add-data "static;static" --collect-submodules rasterio --collect-all certifi --exclude-module tkinter --icon assets\icon.ico
if errorlevel 1 (
